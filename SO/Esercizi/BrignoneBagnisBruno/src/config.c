...
/** @brief Rimuove spazi e terminatori superflui dall'inizio e dalla fine di una stringa.
 * @param s Puntatore alla stringa da trimmare.
 */
...
/** Analizza un campo intero della configurazione, terminando il processo in caso di errore.
 * @param key Il nome del campo di configurazione, usato per messaggi d'errore più chiari.
 * @param value La stringa da analizzare come intero.
 * @return Il valore intero analizzato, se la stringa è valida.
 */
...
/** Copia un campo stringa della configurazione, terminando il processo in caso di errore.
 * @param dst Puntatore al campo stringa di destinazione da aggiornare.
 * @param dst_size La dimensione massima del campo stringa di destinazione, usata per evitare buffer overflow.
 * @param field_name Il nome del campo di configurazione, usato per messaggi d'errore più chiari.
 * @param value La stringa da copiare nel campo di destinazione.
 */
...
/** @brief Aggiorna un campo intero della configurazione in base alla chiave letta dal file.
 * @param cfg Puntatore alla struttura di configurazione da aggiornare.
 * @param key La chiave del campo da aggiornare.
 * @param value Il valore da assegnare al campo.
 * @return true se la chiave è valida e il valore è stato assegnato, false altrimenti.
 */
...
/** @brief Interpreta una riga del file menu e popola la sezione corrispondente della struttura menu.
 * @param menu Puntatore alla struttura menu da popolare.
 * @param line La riga del file menu da interpretare.
 */
